...
window.APP_CONFIG = {
    ...
    "avatar": "assets/images/spheres/a7.jpg",
    "messages": [
        { "id": 1, "side": "left", "text": "hello bé iu", "delay": 0 },
        { "id": 2, "side": "left", "text": "Chúc mừng ngày 1/6 quốc tế thiếu nhi", "delay": 1150 },
        { "id": 3, "side": "left", "text": "Chúc bạn nhỏ của anh mau ăn chóng lớn mập mập mới đáng yêu.", "delay": 2850 },
        { "id": 4, "side": "left", "text": "Và phải ngoan ngoãn nhé. Luôn vui vẻ nữa", "delay": 1000 },
        { "id": 5, "side": "left", "text": "Em xinh lắm rồi nên đừng có suốt ngày đòi giảm cân, rồi thẩm mỹ gì nữa. Em chỉ thua tiên nữ ở cái là biết bay và có phép thuật thôi. ❤️❤️❤️❤️❤️🐭", "delay": 2050 }
    ],
    "heart": {
        "mode": "days",
        "valentineMessageLine1": "",
        "valentineMessageLine2": "",
        "loveStartDate": "2024-05-01",
        "loveDaysLabel": "bên nhau",
        "loveNameLeft": "Tài",
        "loveNameRight": "Nhàn",
        "heartSideImageLeft": "assets/images/spheres/a7.jpg",
        "heartSideImageRight": "assets/images/spheres/a6.jpg",
        "mobileHeartOffsetY": 0.7
    },
    "letter": {
        "type": "cupid",
        "text": "Chúc mừng ngày 1/6\nanh có đôi điều nhắn nhủ tới em\nHy vọng nhiều năm sau nữa, anh và em vẫn cùng nhau nắm tay đi qua tất cả thăng trầm của cuộc sống.\nCảm ơn vì chúng ta đã gặp được nhau.\nVì yêu mà đến, vì thương mà ở lại, vì hiểu nhau mà nhường nhịn nhau đến hiện tại.\nChúc anh và em sẽ luôn vui vẻ và hạnh phúc, mãi bên nhau như vậy nhé",
        "signatureText": "mãi iu em"
    },
    "enableSphereFlyingImages": true,
    "sphereImages": [
        "assets/images/spheres/a1.jpg",
        "assets/images/spheres/a2.jpg",
        "assets/images/spheres/a3.jpg",
        "assets/images/spheres/a4.jpg",
        "assets/images/spheres/a5.jpg",
        "assets/images/spheres/a6.jpg",
        "assets/images/spheres/a7.jpg"
    ],
